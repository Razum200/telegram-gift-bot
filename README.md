...
### `.gitignore` - Защита ваших данных 🛡️
**Это скрытый файл для безопасности!**
- Автоматически защищает ваши личные файлы
- Не дает загрузить API ключи на GitHub
- Не дает загрузить историю покупок
- **Не трогайте этот файл!** Он работает автоматически
